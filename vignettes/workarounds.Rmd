...
This is an issue we have seen on Windows - our initial investigation confirmed this for Windows 7. Jenny Bryan (thanks!) [confirmed this](https://github.com/jennybc/happy-git-with-r/issues/74#issuecomment-359111965) for Windows 10.
...
Jenny Bryan, at ["Happy Git with R"](http://happygitwithr.com/ssh-keys.html), proposed another solution to tell `git2r::cred_ssh_key()` where to find your `.ssh` directory:
