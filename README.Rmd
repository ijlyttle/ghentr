...
Furthermore, you can use the templating functions in your package to create a function to make it easier to create a package repository on your instance of GHE:
...
These arguments are used with the function `use_github_enterprise()` to write some 
